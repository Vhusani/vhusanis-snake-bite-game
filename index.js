(function(){  
    ...
    var _food = function(x, y){
        ctx.fillStyle = "rgb(67, 135, 247)";
        ctx.fillRect(x * 10, y * 10, 10, 10);
    }
    
    var _snake = function(x, y){
        ctx.fillStyle = "#fff";
        ctx.fillRect(x * 10, y * 10, 10, 10);
    }
    ...
    var setSnakeSpeed = function(speed_value){
        ...
        if(speed_value == 35){setWall(1)}
        if(speed_value == 70){setWall(0)}
    }
    ...
    var setWall = function(wall_value){
        wall = wall_value;
        if(wall == 0){screen_snake.style.borderColor = "rgba(52, 168, 83, 0.8)";}
        if(wall == 1){screen_snake.style.borderColor = "rgba(255, 0, 0, 0.8)";}
    }
